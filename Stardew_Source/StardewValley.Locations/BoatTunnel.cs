	...
	public override bool answerDialogue(Response answer)
	{
		if (lastQuestionKey != null && afterQuestion == null)
		{
			...
			case "WillyBoatDonateBatteries_Yes":
				...
				DelayedAction.playSoundAfterDelay("openBox", 600, null, null);
			...
			case "WillyBoatDonateHardwood_Yes":
				...
				DelayedAction.playSoundAfterDelay("Ship", 600, null, null);
			...
			case "WillyBoatDonateIridium_Yes":
				...
				DelayedAction.playSoundAfterDelay("clank", 600, null, null);
				DelayedAction.playSoundAfterDelay("clank", 1200, null, null);
				DelayedAction.playSoundAfterDelay("clank", 1800, null, null);
