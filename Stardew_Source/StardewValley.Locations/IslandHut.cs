...
public class IslandHut : IslandLocation
{
	...
	public virtual void SpitTreeNut()
	{
		...
		if (Game1.currentLocation == this)
		{
			...
			DelayedAction.playSoundAfterDelay("croak", 300, null, null);
			DelayedAction.playSoundAfterDelay("slimeHit", 1250, null, null);
			DelayedAction.playSoundAfterDelay("coin", 1250, null, null);
		}
