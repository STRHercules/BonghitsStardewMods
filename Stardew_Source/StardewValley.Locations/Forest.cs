...
public class Forest : GameLocation
{
		...
		: base(map, name)
	{
		...
		resourceClumps.Add(new ResourceClump(602, 2, 2, new Vector2(1f, 6f), null));
	}
	...
	public override bool answerDialogueAction(string questionAndAnswer, string[] questionParams)
	{
		if (questionAndAnswer == "ForestStump_Yes")
		{
			...
			Game1.player.team.RequestSetSimpleFlag(SimpleFlagType.HasQuest, PlayerActionTarget.All, "134", flagState: false, null);
			return true;
		}
	...
	public void fadedForStumpFix()
	{
		...
		DelayedAction.playSoundAfterDelay("crafting", 1000, null, null);
		DelayedAction.playSoundAfterDelay("crafting", 1500, null, null);
		DelayedAction.playSoundAfterDelay("crafting", 2000, null, null);
		DelayedAction.playSoundAfterDelay("crafting", 2500, null, null);
		DelayedAction.playSoundAfterDelay("axchop", 3000, null, null);
		DelayedAction.playSoundAfterDelay("discoverMineral", 3200, null, null);
	...
	public override void performTenMinuteUpdate(int timeOfDay)
	{
		...
		if (r.NextBool(0.25))
		{
			...
			n.showTextAboveHead(Game1.content.LoadString("Strings\\1_6_Strings:FishingDerby_Exclamation" + whichSaying), null);
