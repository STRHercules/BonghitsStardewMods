...
public class BeachNightMarket : GameLocation
{
	...
	{
		switch (getTileIndexAt(tileLocation, "Buildings", "night market"))
		{
		case 595:
			Utility.TryOpenShopMenu("Festival_NightMarket_DecorationBoat", this, null, null);
			break;
		case 69:
		case 877:
			if (Game1.timeOfDay < 1700)
		...
		case 399:
			...
			break;
		case 70:
			Utility.TryOpenShopMenu("Festival_NightMarket_MagicBoat_Day" + getDayOfNightMarket(), this, null, null);
			break;
		case 68:
			if (Game1.timeOfDay < 1700)
			{
