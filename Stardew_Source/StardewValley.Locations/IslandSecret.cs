...
public class IslandSecret : IslandLocation
{
	...
	public override bool performAction(string[] action, Farmer who, Location tileLocation)
	{
		if (ArgUtility.Get(action, 0) == "BananaShrine")
		{
			if (who.CurrentItem?.QualifiedItemId == "(O)91" && getTemporarySpriteByID(777) == null)
			{
				...
				playSound("coin", null, null);
				DelayedAction.playSoundAfterDelay("grassyStep", 1400, null, null);
				DelayedAction.playSoundAfterDelay("grassyStep", 1800, null, null);
				DelayedAction.playSoundAfterDelay("grassyStep", 2200, null, null);
				DelayedAction.playSoundAfterDelay("grassyStep", 2600, null, null);
				DelayedAction.playSoundAfterDelay("grassyStep", 3000, null, null);
				who.reduceActiveItemByOne();
				Game1.changeMusicTrack("none");
				DelayedAction.playSoundAfterDelay("gorilla_intro", 2000, null, null);
			}
			return true;
		}
	...
	private void gorillaEatBanana(int extra)
	{
		...
		playSound("eat", null, null);
		DelayedAction.playSoundAfterDelay("eat", 600, null, null);
		DelayedAction.playSoundAfterDelay("eat", 1200, null, null);
		DelayedAction.playSoundAfterDelay("eat", 1800, null, null);
		DelayedAction.playSoundAfterDelay("eat", 2400, null, null);
		temporarySprites.Add(gorilla);
	}
