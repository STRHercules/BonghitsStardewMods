...
public class LibraryMuseum : GameLocation
{
	...
	public override void draw(SpriteBatch b)
	{
		...
		foreach (KeyValuePair<Vector2, string> v in museumPieces.Pairs)
		{
			...
			b.Draw(data.GetTexture(), Game1.GlobalToLocal(Game1.viewport, v.Key * 64f), data.GetSourceRect(0, null), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, v.Key.Y * 64f / 10000f);
		}
	}
}
