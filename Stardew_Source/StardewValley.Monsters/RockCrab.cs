...
public class RockCrab : Monster
{
	...
	public override bool hitWithTool(Tool t)
	{
		...
		{
			base.currentLocation.playSound("hammer", null, null);
			shellHealth.Value--;
			shake(500);
			waiter = false;
			moveTowardPlayerThreshold.Value = 3;
			...
			if (shellHealth.Value <= 0)
			{
				...
				moveTowardPlayer(-1);
				base.currentLocation.playSound("stoneCrack", null, null);
				Game1.createRadialDebris(base.currentLocation, 14, tile.X, tile.Y, Game1.random.Next(2, 7), resource: false, -1, item: false, null);
				Game1.createRadialDebris(base.currentLocation, 14, tile.X, tile.Y, Game1.random.Next(2, 7), resource: false, -1, item: false, null);
			}
			return true;
		}
	...
	public override int takeDamage(int damage, int xTrajectory, int yTrajectory, bool isBomb, double addedPrecision, Farmer who)
	{
		...
		{
			actualDamage = 0;
			base.currentLocation.playSound("crafting", null, null);
		}
		else
		{
