...
public class Mummy : Monster
{
	...
	public override int takeDamage(int damage, int xTrajectory, int yTrajectory, bool isBomb, double addedPrecision, Farmer who)
	{
		...
		if (reviveTimer.Value > 0)
		{
			if (isBomb)
			{
				...
				base.currentLocation.playSound("ghost", null, null);
				return 999;
			}
			return -1;
		}
		...
		else
		{
			...
			base.currentLocation.playSound("shadowHit", null, null);
			base.currentLocation.playSound("skeletonStep", null, null);
	...
	private void performCrumble(bool reverse)
	{
		...
		if (!reverse)
		{
			...
			reviveTimer.Value = 10000;
			base.currentLocation.localSound("monsterdead", null, null);
		}
		else
		{
			if (Game1.IsMasterGame)
			...
			reviveTimer.Value = 0;
			base.currentLocation.localSound("skeletonDie", null, null);
		}
	}
