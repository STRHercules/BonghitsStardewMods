...
public class Bat : Monster
{
	...
	public override int takeDamage(int damage, int xTrajectory, int yTrajectory, bool isBomb, double addedPrecision, Farmer who)
	{
		...
		else
		{
			...
			{
				base.currentLocation.playSound("magma_sprite_hit", null, null);
			}
			else
			{
			...
			if (base.Health <= 0)
			{
				...
				if (cursedDoll.Value)
				{
					...
					if (magmaSprite.Value)
					{
						base.currentLocation.playSound("magma_sprite_die", null, null);
						for (int i = 0; i < 20; i++)
						{
					...
					{
						base.currentLocation.playSound("rockGolemHit", null, null);
					}
				...
				{
					base.currentLocation.playSound("batScreech", null, null);
				}
			}
		}
	...
	public override void behaviorAtGameTick(GameTime time)
	{
		...
		if (canLunge.Value)
		{
			...
			else if (nextLunge > 0 && withinPlayerThreshold(6))
			{
				...
				if (nextLunge < 0)
				{
					base.currentLocation.playSound("magma_sprite_spot", null, null);
					nextLunge = 0;
