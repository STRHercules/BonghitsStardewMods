...
public class ShadowShaman : Monster
{
	...
	public override int takeDamage(int damage, int xTrajectory, int yTrajectory, bool isBomb, double addedPrecision, Farmer who)
	{
		...
		else
		{
			...
			if (base.Health <= 0)
			{
				base.currentLocation.playSound("shadowDie", null, null);
				deathAnimation();
			}
		}
		return actualDamage;
	...
	public override void behaviorAtGameTick(GameTime time)
	{
		...
		if (!spottedPlayer && Utility.couldSeePlayerInPeripheralVision(base.Player, this) && Utility.doesPointHaveLineOfSightInMine(base.currentLocation, base.Tile, base.Player.Tile, 8))
		{
			...
			{
				base.currentLocation.playSound("shadowpeep", null, null);
			}
		}
		else if (casting.Value)
		{
			...
			else
			{
				...
				if (lowestHealthMonster != null)
				{
					...
					base.currentLocation.playSound("healSound", null, null);
