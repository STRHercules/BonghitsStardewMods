...
public class DinoMonster : Monster
{
	...
	{
		base.currentLocation.playSound("skeletonDie", null, null);
		base.currentLocation.playSound("grunt", null, null);
	...
	public override void behaviorAtGameTick(GameTime time)
	{
		...
		if (attackState.Value == 0 && withinPlayerThreshold(2))
		{
			...
			if (timeUntilNextAttack < 0)
			{
				...
				nextFireTime = 500;
				totalFireTime = 3000;
				base.currentLocation.playSound("croak", null, null);
			}
		}
		else
		{
			...
			if (nextFireTime > 0)
			{
				...
				if (nextFireTime <= 0)
				{
					if (!firing.Value)
					{
						...
						base.currentLocation.playSound("furnace", null, null);
					}
					float fire_angle = 0f;
