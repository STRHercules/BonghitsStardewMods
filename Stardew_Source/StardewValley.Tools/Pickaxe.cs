	...
	public override void DoFunction(GameLocation location, int x, int y, int power, Farmer who)
	{
		...
		if (o != null)
		{
			if (o.IsBreakableStone())
			{
				if (PlayUseSounds)
				{
					location.playSound("hammer", tile, null);
				}
				if (o.MinutesUntilReady > 0)
				{
					...
					if (o.MinutesUntilReady > 0)
					{
						Game1.createRadialDebris(Game1.currentLocation, 14, tileX, tileY, Game1.random.Next(2, 5), resource: false, -1, item: false, null);
						return;
					}
				}
				...
				Game1.createRadialDebris(location, 14, tileX, tileY, Game1.random.Next(2, 5), resource: false, -1, item: false, null);
				...
				if (o.MinutesUntilReady <= 0)
				{
					...
					if (PlayUseSounds)
					{
						location.playSound("stoneCrack", tile, null);
					}
			...
			else if (o.Name.Contains("Boulder"))
			{
				...
				if (hitsToBoulder >= 4)
				{
					...
					if (PlayUseSounds)
					{
						location.playSound("boulderBreak", tile, null);
					}
				}
			}
		...
		else
		{
			if (PlayUseSounds)
			{
				location.playSound("woodyHit", tile, null);
			}
