...
public class Darts : IMinigame
{
	...
	public void draw(SpriteBatch b)
	{
		...
		else if (points >= 0)
		{
			...
			SpriteText.drawStringWithScrollCenteredAt(b, points_string, (int)(score_position.X + score_shake.X), (int)(score_position.Y + score_shake.Y), "", 1f, null);
		...
		if (gameOverString != "")
		{
			...
			if (points == 0)
			{
				...
				SpriteText.drawStringWithScrollCenteredAt(b, gameOverString, (int)score_position.X, (int)score_position.Y, "", 1f, null);
