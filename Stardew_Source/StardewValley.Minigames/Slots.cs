...
public class Slots : IMinigame
{
	...
	public bool tick(GameTime time)
	{
		...
		if (endTimer > 0)
		{
			...
			if (endTimer <= 0)
			{
				...
				{
					showResult = true;
					Game1.playSound((!(payoutModifier >= 5f)) ? "newArtifact" : ((payoutModifier >= 10f) ? "reward" : "money"), null);
				}
				else
				{
	...
	public void draw(SpriteBatch b)
	{
		...
		SpriteText.drawStringWithScrollBackground(b, coinBuffer + Game1.player.clubCoins, Game1.graphics.GraphicsDevice.Viewport.Width / 2 - 376, Game1.graphics.GraphicsDevice.Viewport.Height / 2 - 120, "", 1f, null);
