...
public class GiantCrop : ResourceClump
{
	...
	public override bool performToolAction(Tool t, int damage, Vector2 tileLocation)
	{
		...
		Game1.createRadialDebris(Game1.currentLocation, 12, (int)tileLocation.X + width.Value / 2, (int)tileLocation.Y + height.Value / 2, r.Next(4, 9), resource: false, -1, item: false, null);
		if (shakeTimer <= 0f)
		{
			shakeTimer = 100f;
		...
		if (health.Value <= 0f)
		{
			...
			Game1.createRadialDebris(Game1.currentLocation, 12, (int)tileLocation.X + width.Value / 2, (int)tileLocation.Y + width.Value / 2, r.Next(4, 9), resource: false, -1, item: false, null);
