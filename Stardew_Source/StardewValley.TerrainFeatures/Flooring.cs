...
public class Flooring : TerrainFeature
{
	...
	public override bool performToolAction(Tool t, int damage, Vector2 tileLocation)
	{
		...
		if ((t != null || damage > 0) && (damage > 0 || t is Pickaxe || t is Axe))
		{
			...
			if (data != null)
			{
				location.playSound(data.RemovalSound ?? data.PlacementSound, tileLocation, null);
				Game1.createRadialDebris(location, data.RemovalDebrisType, (int)tileLocation.X, (int)tileLocation.Y, 4, resource: false, -1, item: false, null);
				if (data.ItemId != null)
				{
