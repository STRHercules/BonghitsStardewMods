...
public class BuildingSkinMenu : IClickableMenu
{
	...
	public override void draw(SpriteBatch b)
	{
		...
		SpriteText.drawStringWithScrollCenteredAt(b, Game1.content.LoadString("Strings\\Buildings:BuildingSkinMenu_ChooseAppearance", BuildingDisplayName), xPositionOnScreen + width / 2, PreviewPane.Top - 96, "", 1f, null);
		OkButton.draw(b);
