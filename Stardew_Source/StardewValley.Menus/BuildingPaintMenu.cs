...
public class BuildingPaintMenu : IClickableMenu
{
	...
	public override void draw(SpriteBatch b)
	{
		...
		Game1.DrawBox(previewPane.X, previewPane.Y, previewPane.Width, previewPane.Height, null);
		...
		Game1.DrawBox(colorPane.X, colorPane.Y, colorPane.Width, colorPane.Height, null);
		RegionData region = regions[currentPaintRegion];
		int text_height = SpriteText.getHeightOfString(region.DisplayName);
		SpriteText.drawStringHorizontallyCenteredAt(b, region.DisplayName, colorPane.X + colorPane.Width / 2, nextRegionButton.bounds.Center.Y - text_height / 2, 999999, -1, 999999, 1f, 0.88f, junimoText: false, null);
		okButton.draw(b);
