...
public class CollectionsPage : IClickableMenu
{
		...
		: base(x, y, width, height)
	{
		...
		foreach (ParsedItemData data in dataEntries)
		{
			...
			list.Add(new ClickableTextureComponent(id + " " + farmerHas + " " + farmerHasButNotMade, new Rectangle(xPos, yPos, 64, 64), null, "", itemData.GetTexture(), itemData.GetSourceRect(0, null), 4f, farmerHas)
			{
				myID = list.Count,
	...
	public override void draw(SpriteBatch b)
	{
		...
		{
			IClickableMenu.drawHoverText(b, hoverText, Game1.smallFont, 0, 0, this.value, null, -1, null, null, 0, null, -1, -1, -1, 1f, null, null, null, null, null, null);
