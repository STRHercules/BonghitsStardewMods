...
public class CharacterCustomization : IClickableMenu
{
	...
	public override void draw(SpriteBatch b)
	{
		...
		if (text != null && text.Length > 0)
		{
			...
			IClickableMenu.drawHoverText(b, Game1.parseText(hoverText, Game1.smallFont, width), Game1.smallFont, 0, 0, -1, hoverTitle, -1, null, null, 0, null, -1, -1, -1, 1f, null, null, null, null, null, null);
		}
		drawMouse(b);
	}
