...
public class SpecialOrdersBoard : IClickableMenu
{
	...
	public override void draw(SpriteBatch b)
	{
		...
		if (!Game1.player.team.acceptedSpecialOrderTypes.Contains(GetOrderType()))
		{
			SpriteText.drawStringWithScrollCenteredAt(b, Game1.content.LoadString("Strings\\UI:ChooseOne"), xPositionOnScreen + width / 2, Math.Max(10, yPositionOnScreen - 70), SpriteText.getWidthOfString(Game1.content.LoadString("Strings\\UI:ChooseOne") + "W"), 1f, null);
		}
		if (leftOrder != null)
		{
			SpecialOrder order = leftOrder;
