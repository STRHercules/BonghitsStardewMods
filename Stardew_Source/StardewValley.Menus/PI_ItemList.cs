...
public class PI_ItemList : ProfileItem
{
	...
	protected void _UpdateIcons()
	{
		...
		for (int i = 0; i < _items.Count; i++)
		{
			...
			ClickableTextureComponent component = new ClickableTextureComponent(item.DisplayName, new Rectangle((int)draw_position.X, (int)draw_position.Y, 32, 32), null, "", itemData.GetTexture(), itemData.GetSourceRect(0, null), 2f)
			{
				myID = 0,
