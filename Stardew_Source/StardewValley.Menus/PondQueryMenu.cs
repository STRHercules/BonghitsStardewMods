...
public class PondQueryMenu : IClickableMenu
{
	...
	public override void draw(SpriteBatch b)
	{
		if (!Game1.globalFade)
		{
			...
			Game1.DrawBox((int)((float)(Game1.uiViewport.Width / 2) - (text_size.X + 64f) * 0.5f), yPositionOnScreen - 4 + 128, (int)(text_size.X + 64f), 64, null);
			...
			if (confirmingEmpty)
			{
				...
				Game1.DrawBox(_confirmationBoxRectangle.X, _confirmationBoxRectangle.Y, _confirmationBoxRectangle.Width, _confirmationBoxRectangle.Height, null);
				_confirmationBoxRectangle.Width -= padding;
				_confirmationBoxRectangle.Height -= padding;
				_confirmationBoxRectangle.X += padding / 2;
				_confirmationBoxRectangle.Y += padding / 2;
