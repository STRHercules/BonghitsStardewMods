...
public class CoopMenu : LoadGameMenu
{
	...
	protected abstract class LabeledSlot : CoopMenuSlot
	{
		...
		public override void Draw(SpriteBatch b, int i)
		{
			...
			SpriteText.drawString(b, message, x, y, 999999, -1, 999999, 1f, 0.88f, junimoText: false, -1, "", null);
		}
	}
	...
	protected class FriendFarmSlot : CoopMenuSlot
	{
		...
		{
			SpriteText.drawString(b, slotName(), menu.slotButtons[i].bounds.X + 128 + 36, menu.slotButtons[i].bounds.Y + 36, 999999, -1, 999999, 1f, 0.88f, junimoText: false, -1, "", null);
		}
	...
	protected override void drawStatusText(SpriteBatch b)
	{
		...
		else if (!isSetUp)
		{
			...
			SpriteText.drawString(b, currentText, Game1.graphics.GraphicsDevice.Viewport.Bounds.Center.X - maxWidth / 2, Game1.graphics.GraphicsDevice.Viewport.Bounds.Center.Y, 999999, -1, 999999, 1f, 0.88f, junimoText: false, -1, "", null);
		}
	}
