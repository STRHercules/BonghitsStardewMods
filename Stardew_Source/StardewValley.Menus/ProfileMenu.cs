...
public class ProfileMenu : IClickableMenu
{
	...
	public void PlayHiddenEmote()
	{
		if (Current.HeartLevel >= 4)
		{
			...
			Game1.playSound(data?.HiddenProfileEmoteSound ?? "drumkit6", null);
	...
	public override void draw(SpriteBatch b)
	{
		...
		Game1.DrawBox(_characterStatusDisplayBox.X, _characterStatusDisplayBox.Y, _characterStatusDisplayBox.Width, _characterStatusDisplayBox.Height, null);
		...
		{
			SpriteText.drawStringWithScrollCenteredAt(b, "", (int)_characterNamePosition.X, (int)_characterNamePosition.Y, _printedName, 1f, null);
		}
		else
		{
			SpriteText.drawStringWithScrollCenteredAt(b, Current.DisplayName, (int)_characterNamePosition.X, (int)_characterNamePosition.Y, "", 1f, null);
		}
		if (npc != null && npc.birthday_Season.Value != null)
		{
			...
			if (season_number >= 0)
			{
				SpriteText.drawStringHorizontallyCenteredAt(b, Game1.content.LoadString("Strings\\UI:Profile_Birthday"), (int)_birthdayHeadingDisplayPosition.X, (int)_birthdayHeadingDisplayPosition.Y, 999999, -1, 999999, 1f, 0.88f, junimoText: false, null);
			...
			if (_status != "")
			{
				SpriteText.drawStringHorizontallyCenteredAt(b, Game1.content.LoadString("Strings\\UI:Profile_Status"), (int)_statusHeadingDisplayPosition.X, (int)_statusHeadingDisplayPosition.Y, 999999, -1, 999999, 1f, 0.88f, junimoText: false, null);
		...
		SpriteText.drawStringWithScrollCenteredAt(b, Game1.content.LoadString("Strings\\UI:Profile_GiftLog"), (int)_giftLogHeadingDisplayPosition.X, (int)_giftLogHeadingDisplayPosition.Y, "", 1f, null);
		SpriteText.drawStringHorizontallyCenteredAt(b, Game1.content.LoadString("Strings\\UI:" + itemCategories[_currentCategory].categoryName, Current.DisplayName), (int)_giftLogCategoryDisplayPosition.X, (int)_giftLogCategoryDisplayPosition.Y, 999999, -1, 999999, 1f, 0.88f, junimoText: false, null);
