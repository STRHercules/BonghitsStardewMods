...
public class PurchaseAnimalsMenu : IClickableMenu
{
	...
	public override void draw(SpriteBatch b)
	{
		if (!onFarm && !Game1.dialogueUp && !Game1.IsFading())
		{
			...
			SpriteText.drawStringWithScrollBackground(b, Game1.content.LoadString("Strings\\StringsFromCSFiles:PurchaseAnimalsMenu.cs.11354"), xPositionOnScreen + 96, yPositionOnScreen, "", 1f, null);
		...
		else if (!Game1.IsFading() && onFarm)
		{
			...
			SpriteText.drawStringWithScrollBackground(b, s, Game1.uiViewport.Width / 2 - SpriteText.getWidthOfString(s) / 2, 16, "", 1f, null);
			if (namingAnimal)
			{
				if (!Game1.options.showClearBackgrounds)
				{
		...
		if (hovered != null)
		{
			...
			{
				IClickableMenu.drawHoverText(b, Game1.parseText((hovered.item as Object).Type, Game1.dialogueFont, 320), Game1.dialogueFont, 0, 0, -1, null, -1, null, null, 0, null, -1, -1, -1, 1f, null, null, null, null, null, null);
			}
			else
			{
				string displayName = FarmAnimal.GetDisplayName(hovered.hoverText, forShop: true);
				SpriteText.drawStringWithScrollBackground(b, displayName, xPositionOnScreen + IClickableMenu.spaceToClearSideBorder + 64, yPositionOnScreen + height + -32 + IClickableMenu.spaceToClearTopBorder / 2 + 8, "Truffle Pig", 1f, null);
				SpriteText.drawStringWithScrollBackground(b, "$" + Game1.content.LoadString("Strings\\StringsFromCSFiles:LoadGameMenu.cs.11020", hovered.item.salePrice()), xPositionOnScreen + IClickableMenu.spaceToClearSideBorder + 128, yPositionOnScreen + height + 64 + IClickableMenu.spaceToClearTopBorder / 2 + 8, "$99999999g", (Game1.player.Money >= hovered.item.salePrice()) ? 1f : 0.5f, null);
				string description = FarmAnimal.GetShopDescription(hovered.hoverText);
				IClickableMenu.drawHoverText(b, Game1.parseText(description, Game1.smallFont, 320), Game1.smallFont, 0, 0, hovered.item.salePrice(), displayName, -1, null, null, 0, null, -1, -1, -1, 1f, null, null, null, null, null, null);
			}
		}
