...
public class ShopMenu : IClickableMenu
{
	...
	public void AddForSale(ISalable item, ItemStockInformation stock = null)
	{
		...
		forSale.Add(item);
		itemPriceAndStock.Add(item, stock ?? new ItemStockInformation(item.salePrice(), item.Stack, null, null, LimitedStockMode.Global, null, null, null));
	}
	...
	public void UseFurnitureCatalogueTabs()
	{
		tabButtons = new List<ShopTabClickableTextureComponent>
		{
			...
			new ShopTabClickableTextureComponent(new Rectangle(0, 0, 64, 64), Game1.mouseCursors2, new Rectangle(64, 48, 16, 16), 4f)
			{
				...
				downNeighborID = -99998,
				rightNeighborID = 3546,
				Filter = (ISalable item) => item is Furniture furniture2 && (furniture2.furniture_type.Value == 0 || furniture2.furniture_type.Value == 1 || furniture2.furniture_type.Value == 2 || furniture2.furniture_type.Value == 3)
			},
			...
			new ShopTabClickableTextureComponent(new Rectangle(0, 0, 64, 64), Game1.mouseCursors2, new Rectangle(96, 64, 16, 16), 4f)
			{
				...
				downNeighborID = -99998,
				rightNeighborID = 3546,
				Filter = (ISalable item) => item is Furniture furniture4 && furniture4.furniture_type.Value == 12
			},
			new ShopTabClickableTextureComponent(new Rectangle(0, 0, 64, 64), Game1.mouseCursors2, new Rectangle(80, 64, 16, 16), 4f)
			{
				...
				downNeighborID = -99998,
				rightNeighborID = 3546,
				Filter = (ISalable item) => item is Furniture furniture5 && (furniture5.furniture_type.Value == 7 || furniture5.furniture_type.Value == 17 || furniture5.furniture_type.Value == 10 || furniture5.furniture_type.Value == 8 || furniture5.furniture_type.Value == 9 || furniture5.furniture_type.Value == 14)
			}
		};
		repositionTabs();
	}
	...
	public void UseDresserTabs()
	{
		tabButtons = new List<ShopTabClickableTextureComponent>
		{
			...
			new ShopTabClickableTextureComponent(new Rectangle(0, 0, 64, 64), Game1.mouseCursors2, new Rectangle(16, 48, 16, 16), 4f)
			{
				...
				downNeighborID = -99998,
				rightNeighborID = 3546,
				Filter = (ISalable salable) => salable is Item item2 && item2.Category == -95
			},
			...
			new ShopTabClickableTextureComponent(new Rectangle(0, 0, 64, 64), Game1.mouseCursors2, new Rectangle(48, 48, 16, 16), 4f)
			{
				...
				downNeighborID = -99998,
				rightNeighborID = 3546,
				Filter = (ISalable salable) => salable is Clothing clothing2 && clothing2.clothesType.Value == Clothing.ClothesType.PANTS
			},
			...
			new ShopTabClickableTextureComponent(new Rectangle(0, 0, 64, 64), Game1.mouseCursors2, new Rectangle(16, 64, 16, 16), 4f)
			{
				...
				downNeighborID = -99998,
				rightNeighborID = 3546,
				Filter = (ISalable salable) => salable is Item item4 && item4.Category == -96
			}
		};
		repositionTabs();
	}
	...
	public virtual ISalable AddBuybackItem(ISalable sold_item, int sell_unit_price, int stack)
	{
		...
		while (stack > 0)
		{
			...
			if (target == null)
			{
				...
				itemPriceAndStock.Add(target, new ItemStockInformation(sell_unit_price, amount_to_deposit, null, null, LimitedStockMode.Global, null, null, null));
				target.Stack = 1;
	...
	{
		Game1.playSound(openMenuSound, null);
	}
			...
			if (getPlayerCurrencyAmount(Game1.player, currency) >= price && (extraTradeItem == null || HasTradeItem(extraTradeItem, extraTradeItemCount)))
			{
				...
				else
				{
					...
					if (Game1.mouseClickPolling > 300)
					{
						...
						{
							Game1.playSound(purchaseRepeatSound, null);
						}
					}
