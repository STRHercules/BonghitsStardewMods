...
public class CraftingPage : IClickableMenu
{
	...
	public override void draw(SpriteBatch b)
	{
		...
		else if (!string.IsNullOrEmpty(hoverText))
		{
			...
			{
				IClickableMenu.drawHoverText(b, hoverText, Game1.smallFont, (heldItem != null) ? 64 : 0, (heldItem != null) ? 64 : 0, -1, null, -1, null, null, 0, null, -1, -1, -1, 1f, null, null, null, null, null, null);
			}
		}
