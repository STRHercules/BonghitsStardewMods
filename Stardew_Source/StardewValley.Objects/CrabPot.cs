...
public class CrabPot : Object
{
	...
	public override bool placementAction(GameLocation location, int x, int y, Farmer who = null)
	{
		...
		location.playSound("waterSlosh", null, null);
		DelayedAction.playSoundAfterDelay("slosh", 150, null, null);
		updateOffset();
		addOverlayTiles();
		return true;
	}
	...
	public override bool checkForAction(Farmer who, bool justCheckingForActivity = false)
	{
		...
		if (tileIndexToShow == 714)
		{
			...
			location.playSound("fishingRodBend", null, null);
	...
	public override void draw(SpriteBatch spriteBatch, int x, int y, float alpha = 1f)
	{
		...
		if (readyForHarvest.Value && heldObject.Value != null)
		{
			...
			spriteBatch.Draw(heldItemData.GetTexture(), Game1.GlobalToLocal(Game1.viewport, directionOffset.Value + new Vector2(x * 64 + 32, (float)(y * 64 - 64 - 8) + yOffset)), heldItemData.GetSourceRect(0, null), Color.White * 0.75f, 0f, new Vector2(8f, 8f), 4f, SpriteEffects.None, (float)((y + 1) * 64) / 10000f + 1E-05f + tileLocation.X / 10000f);
		}
	}
}
