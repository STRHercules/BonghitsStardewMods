...
public class IndoorPot : Object
{
	...
	public override bool checkForAction(Farmer who, bool justCheckingForActivity = false)
	{
		if (who != null)
		{
			...
			if (crop != null && crop.currentPhase.Value > 0 && hoeDirt.Value.getMaxShake() == 0f)
			{
				...
				DelayedAction.playSoundAfterDelay("leafrustle", Game1.random.Next(100), null, null);
			}
	...
	public override void draw(SpriteBatch spriteBatch, int x, int y, float alpha = 1f)
	{
		...
		spriteBatch.Draw(itemData.GetTexture(), destination, itemData.GetSourceRect(showNextIndex.Value ? 1 : 0, null), Color.White * alpha, 0f, Vector2.Zero, SpriteEffects.None, Math.Max(0f, (float)((y + 1) * 64 - 24) / 10000f) + (float)x * 1E-05f);
