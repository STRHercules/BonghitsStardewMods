...
public class Furniture : Object, ISittable
{
	...
	public void InitializeAtTile(Vector2 tile)
	{
		...
		{
			defaultSourceRect.Value = ItemRegistry.GetDataOrErrorItem(base.QualifiedItemId).GetSourceRect(0, null);
		}
	...
	public override bool checkForAction(Farmer who, bool justCheckingForActivity = false)
	{
		...
		case "(F)Cauldron":
			...
			if (base.IsOn)
			{
				location.playSound("fireball", null, null);
				location.playSound("bubbles", null, null);
				for (int i = 0; i < 13; i++)
				{
		...
		case "(F)RetroCatalogue":
			Utility.TryOpenShopMenu("RetroFurnitureCatalogue", location, null, null);
			break;
		case "(F)TrashCatalogue":
			Utility.TryOpenShopMenu("TrashFurnitureCatalogue", location, null, null);
			break;
		case "(F)JunimoCatalogue":
			Utility.TryOpenShopMenu("JunimoFurnitureCatalogue", location, null, null);
			break;
		case "(F)WizardCatalogue":
			...
			{
				Utility.TryOpenShopMenu("WizardFurnitureCatalogue", location, null, null);
			}
			return true;
		case "(F)JojaCatalogue":
			...
			{
				Utility.TryOpenShopMenu("JojaFurnitureCatalogue", location, null, null);
			}
			return true;
		case "(F)1308":
			Utility.TryOpenShopMenu("Catalogue", location, null, null);
			return true;
		case "(F)1226":
			Utility.TryOpenShopMenu("Furniture Catalogue", location, null, null);
			return true;
		case "(F)1309":
	...
	public virtual void setFireplace(bool playSound = true, bool broadcast = false)
	{
		...
		if (isOn.Value)
		{
			...
			if (playSound)
			{
				location.localSound("fireball", null, null);
			}
	...
	public override void drawInMenu(SpriteBatch spriteBatch, Vector2 location, float scaleSize, float transparency, float layerDepth, StackDrawType drawStackNumber, Color color, bool drawShadow)
	{
		...
		spriteBatch.Draw(itemData.GetTexture(), location + new Vector2(32f, 32f), itemData.GetSourceRect(0, null), color * transparency, 0f, new Vector2(sourceRect.Width / 2, sourceRect.Height / 2), 1f * getScaleSize() * scaleSize, SpriteEffects.None, layerDepth);
	...
	public override void draw(SpriteBatch spriteBatch, int x, int y, float alpha = 1f)
	{
		...
		if (heldObject.Value != null)
		{
			...
			else
			{
				...
				{
					spriteBatch.Draw(heldItemData.GetTexture(), Game1.GlobalToLocal(Game1.viewport, new Vector2(boundingBox.Center.X - 32, boundingBox.Center.Y - (drawHeldObjectLow.Value ? 32 : 85))), heldItemData.GetSourceRect(0, null), Color.White * alpha, 0f, Vector2.Zero, 4f, SpriteEffects.None, (float)(boundingBox.Bottom + 1) / 10000f);
				}
			}
		}
