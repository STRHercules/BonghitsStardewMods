...
public abstract class Tool : Item
{
	...
	public virtual void endUsing(GameLocation location, Farmer who)
	{
		...
		if (this is WateringCan wateringCan)
		{
			...
			{
				who.playNearbySoundLocal("wateringCan", null);
			}
	...
	public override void drawInMenu(SpriteBatch spriteBatch, Vector2 location, float scaleSize, float transparency, float layerDepth, StackDrawType drawStackNumber, Color color, bool drawShadow)
	{
		...
		spriteBatch.Draw(data.GetTexture(), location + new Vector2(32f, 32f), data.GetSourceRect(0, null), color * transparency, 0f, new Vector2(8f, 8f), 4f * scaleSize, SpriteEffects.None, layerDepth);
				...
				if (!(enchantment is DiamondEnchantment))
				{
					if (enchantment is GalaxySoulEnchantment && this is MeleeWeapon weapon && weapon.isGalaxyWeapon() && weapon.GetEnchantmentLevel<GalaxySoulEnchantment>() >= 3)
					{
						...
						if (newItemId != null)
						{
							...
							{
								DelayedAction.playSoundAfterDelay("discoverMineral", 400, null, null);
