		...
		if (buddy != null)
		{
			...
			case 4:
				...
				if (buddyTimer <= 0)
				{
					...
					DelayedAction.playSoundAfterDelay("dustMeep", 400, null, null);
					DelayedAction.playSoundAfterDelay("dustMeep", 800, null, null);
					DelayedAction.playSoundAfterDelay("dustMeep", 1200, null, null);
				}
				break;
			case 5:
				if (buddyTimer > 1000)
