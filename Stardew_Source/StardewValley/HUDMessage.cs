...
public class HUDMessage
{
	...
	public virtual void draw(SpriteBatch b, int i, ref int heightUsed)
	{
		...
		if (noIcon)
		{
			...
			heightUsed += height;
			IClickableMenu.drawHoverText(b, message, Game1.dialogueFont, 0, 0, -1, null, -1, null, null, 0, null, -1, overrideX, overrideY, transparency, null, null, null, null, null, null);
			return;
		}
		int height2 = 112;
