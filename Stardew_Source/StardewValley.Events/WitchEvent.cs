...
public class WitchEvent : BaseFarmEvent
{
	...
	public override bool setUp()
	{
		...
		DelayedAction.playSoundAfterDelay(goldenWitch ? "yoba" : "cacklingWitch", 3200, null, null);
		return false;
	}
			...
			if (witchAnimationTimer > 2000)
			{
				...
				if (!animateLeft)
				{
					...
					if (witchFrame == 1)
					{
						...
						Game1.playSound(goldenWitch ? "discoverMineral" : "debuffSpell", null);
					}
				}
				else
				{
					...
					DelayedAction.playSoundAfterDelay(goldenWitch ? "yoba" : "cacklingWitch", 2500, null, null);
				}
			}
		}
		else
