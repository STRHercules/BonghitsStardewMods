	...
	public void resetForPlayerEntry(Point targetTile)
	{
		...
		case 15:
		{
			...
			for (int l = 0; l < 20; l++)
			{
				...
				DelayedAction.playSoundAfterDelay("parrot_flap", 500 + l * 250, null, null);
				DelayedAction.playSoundAfterDelay("parrot_flap", 5500 + l * 250, null, null);
		...
		case 12:
		{
			...
			DelayedAction.playSoundAfterDelay("thunder_small", 6000, null, null);
			DelayedAction.playSoundAfterDelay("boulderBreak", 6300, null, null);
		...
		case 14:
		{
			...
			for (int j = 0; j < 20; j++)
			{
				...
				DelayedAction.playSoundAfterDelay("batFlap", 3500 + j * 250, null, null);
