...
public class ParrotPlatform
{
	...
	public class Parrot
	{
		...
		public virtual void Draw(SpriteBatch b)
		{
			...
			b.Draw(texture, Game1.GlobalToLocal(Game1.viewport, draw_position - new Vector2(0f, height * 4f) + draw_offset * 4f), new Microsoft.Xna.Framework.Rectangle((base_frame2 + frame_off) * 24, 0, 24, 24), Color.White, 0f, new Vector2(12f, 19f), 4f, facingRight ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (draw_position.Y + 0.1f + 128f) / 10000f);
