...
public class JumpingFish
{
	...
	public void Draw(SpriteBatch b)
	{
		...
		b.Draw(itemData.GetTexture(), Game1.GlobalToLocal(Game1.viewport, draw_position), itemData.GetSourceRect(0, null), Color.White, drawn_angle, origin, 4f * draw_scale, effect, position.Y / 10000f + 1E-06f);
